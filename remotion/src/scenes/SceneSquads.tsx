...
const SQUADS = [
  ...
  },
  {
    name: "Squad Gamma",
    color: C.success,
    managers: [{ name: "Thiago Reis", influencers: 11 }],
  },
];
    ...
    <AbsoluteFill style={{ padding: 80, gap: 32, flexDirection: "column" }}>
      <div style={{ opacity: captionIn, transform: `translateY(${interpolate(captionIn, [0, 1], [16, 0])}px)` }}>
        <CaptionBar
          ...
          sub="Cada squad tem seus gerentes. Ao aprovar um card no pipeline, o influenciador cai automaticamente na fila do gerente com menos carga."
        />
      </div>
              ...
              return (
                <div
                  ...
                  style={{
                    borderRadius: 14,
                    padding: 20,
                    background: `linear-gradient(180deg, ${sq.color}18, ${C.surface} 80%)`,
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <div style={{ width: 12, height: 12, borderRadius: 999, background: sq.color, boxShadow: `0 0 16px ${sq.color}` }} />
                    <div style={{ fontFamily: DISPLAY, fontSize: 20, fontWeight: 600, color: C.text, flex: 1, letterSpacing: -0.3 }}>
                      {sq.name}
                    </div>
                    <div style={{ fontSize: 10, color: C.muted, padding: "2px 8px", borderRadius: 999, background: "rgba(255,255,255,0.05)" }}>
