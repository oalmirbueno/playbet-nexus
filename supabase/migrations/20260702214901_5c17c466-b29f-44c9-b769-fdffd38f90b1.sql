...
BEGIN
  ...
  -- Auto-materials only need creation once; updates keep existing edited assets intact.
...
CREATE TRIGGER trg_tracking_links_autopipeline
  AFTER INSERT OR UPDATE OF game_slug, game_name, game_icon_url, link_category, hype_reason, hype_priority, base_url, short_url, landing_page_instance_id, platform_account_id
