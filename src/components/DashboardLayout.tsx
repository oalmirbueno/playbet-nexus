    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      >
        ...
        <div className={`flex items-center ${sidebarCollapsed ? "justify-center px-2" : "justify-between px-5"} h-[60px] border-b border-sidebar-border shrink-0`}>
          {!sidebarCollapsed && <img src={logo} alt="PlayBet" className="h-14 opacity-90" />}
          {sidebarCollapsed && <img src={logo} alt="PlayBet" className="h-9 w-9 object-contain opacity-90" />}
