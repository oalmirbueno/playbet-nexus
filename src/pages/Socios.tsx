...
import { Plus, Edit, ArrowRight, DollarSign, Wallet, TrendingUp, Users } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          {data.length > 0 && <ExportDropdown data={data.map(({ id, nome, part, ganhos, disponivel, ultimoSaque, status }) => ({ id, nome, part, ganhos, disponivel, ultimoSaque, status }))} filename="socios-playbet" />}
